...
create table sys_dept (
  ...
  organization_id   bigint(20) DEFAULT NULL COMMENT '单位ID',
  primary key (dept_id)
...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '山东网聪信息科技有限公司',   0, 'admin', '15888888888', 'admin@gridnt.com', '0', '0', 'admin', sysdate(), '', null, null);
...
create table sys_user (
  ...
  organization_id   bigint(20)      default null               comment '单位的ID',
  primary key (user_id)
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', '系统管理员', '00', 'admin@gridnt.com', '', '1', '', '$2a$10$icYKAJMeS/6W//ielhY1ceaLrrv/C1h2qzcrhH8wryLgzhdOp3Cg.', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '管理员', 0);
...
INSERT INTO sys_config VALUES (4, '登录最大失败次数', 'sys.login.failMaxTimes', '4', 'Y', 'admin', '2021-06-08 10:12:30', 'admin', '2021-06-08 10:12:45', '登录失败次数到达后，用户会被锁定 ');
INSERT INTO sys_config VALUES (5, '用户可用登录的方式', 'sys.login.loginWay', '111', 'Y', 'admin', '2021-06-08 10:13:30', 'admin', '2021-06-08 10:14:06', '账号，手机，邮箱');
...
create table gen_table (
  ...
  update_time       datetime                                   comment '更新时间',
  remark            varchar(500)    default null               comment '备注',
  context_path      varchar(255) DEFAULT NULL COMMENT '记下应用的contextPath.api.js中会用到',
  plus              int(1) DEFAULT NULL COMMENT '0 mybatis  1 mybatis-plus',
