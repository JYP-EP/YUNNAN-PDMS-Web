  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="openDataScope" width="500px" append-to-body  :close-on-click-modal="false">
      <el-form :model="form" label-width="100px">
        ...
        <el-form-item label="数据权限" v-show="form.dataScope == 6">
...
import {roleOrgTreeselect} from "@/api/system/organization";
...
// 所有菜单节点数据
    ...
    submitDataScope: function() {
      if (this.form.roleId != undefined) {
        ...
        this.form.organizationIds = this.getOrgAllCheckedKeys();
